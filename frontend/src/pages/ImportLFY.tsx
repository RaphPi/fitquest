...
import { Upload, FileJson, CheckCircle2, XCircle, Loader2, AlertCircle, ArrowLeft } from 'lucide-react';
    ...
    <section className="max-w-lg space-y-4">
      <div className="mb-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Importe exercices et programmes depuis un fichier <span className="font-mono text-foreground">lfy_import.json</span>.
        </p>
      </div>
              ...
              <div className="border-t border-border px-5 pb-5 pt-4">
                ...
                <ul className="space-y-1">
                  {result.errors.map((err, i) => (
                    // static list, index key acceptable
